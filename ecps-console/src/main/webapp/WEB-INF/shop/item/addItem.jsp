...
$(function(){
	...
	$("#button2").click(function(){
		...
		.replace(/showStatus1/g,"showStatus"+divNum)
		.replace(/sort1/g,"sort"+divNum)
		.replace(/skuPrice1/g,"skuPrice"+divNum)
		.replace(/marketPrice1/g,"marketPrice"+divNum)
		.replace(/stockInventory1/g,"stockInventory"+divNum)
		.replace(/skuUpperLimit1/g,"skuUpperLimit"+divNum)
		.replace(/sku1/g,"sku"+divNum)
		.replace(/location1/g,"location"+divNum);
...
<div id="tab_1" class="edit set">
	...
	<input type="text" reg1="^(.{1,100})$" desc="100以内任意字符" id="itemName" name="itemName" class="text state" value=""  maxlength="100"/></p>
    ...
    <p><label></label>
        ...
        <input type='hidden' id='imgSize1' name='imgs' value='' reg="^.+$" tip="亲！您忘记上传图片了。" />
	</p>
	...
	<p><label class="alg_t">页面描述：</label>
    ...
    <div id="sp_0" class="sp_0">
        <table cellspacing="0" summary="" class="tab3">
            ...
            <tr>
              ...
              <td>
               <c:forEach items="${feature.selectValues }" var="para">
                 <input type="radio" value="${para }" name="${feature.featureId }specradio1">${para }&nbsp;                 
               </c:forEach>
              </td>
            </tr>
            </c:forEach>
