	...
	$(".spec a").click(function(){
		...
		$.ajax({
			...
			success:function(responseText){
				...
				$("#stockState").html(stockInventory);
				if(stockInventory >0){
					$("#buyNow").show();
					$("#addMyCart").show();
				}else{
		...
		<div class="product">
			...
			<form method="post" action="" name="" class="infor">
				...
				<div class="box_orange">
					...
					<li><label>我 要 买：</label><a href="javascript:void(0);" class="inb sub"></a><input readonly type="text" id="quantity" name="" value="1" class="num" size="3" /><a href="javascript:void(0);" class="inb add"></a><em id="sub_add_msg" class="red"></em></li>
					<li class="submit">
