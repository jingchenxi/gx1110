...
<div class="w loc">
	...
	<p class="l"><a href="#" title="商城首页">商城首页</a><samp>|</samp><a href="${path }/user/login/toPersonl.do" title="我的商城">我的商城</a></p>
		...
		<h2 class="h2 h2_filter mt"><em title="手机商品筛选">手机&nbsp;-&nbsp;商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			...
			<ul class="uls filter">
				...
				<li><b>价格：</b><p>
					...
					<a href="javascript:void(0);" fType="price" fValue="1-499" title="1-499">1-499</a>
					<a href="javascript:void(0);" fType="price" fValue="500-999" title="500-999">500-999</a>
					<a href="javascript:void(0);" fType="price" fValue="1000-1999" title="1000-1999">1000-1999</a>
					<a href="javascript:void(0);" fType="price" fValue="2000-2999" title="2000-2999">2000-2999</a>
					<a href="javascript:void(0);" fType="price" fValue="3000-3999" title="3000-3999">3000-3999</a>
					<a href="javascript:void(0);" fType="price" fValue="4000-4999" title="4000-4999">4000-4999</a>
					<a href="javascript:void(0);" fType="price" fValue="5000-100000" title="5000-100000">5000以上</a>
				</p></li>
				...
				<li><b>品牌：</b><p>
					...
					<a href="javascript:void(0);" fType="brand" fValue="${brand.brandId }" title="${brand.brandName }">${brand.brandName }</a>
					</c:forEach>
				...
				<p>
					...
					<a href="javascript:void(0);" fType="feature" fValue="${val }" title="${val }">${val }</a>
					</c:forEach>
