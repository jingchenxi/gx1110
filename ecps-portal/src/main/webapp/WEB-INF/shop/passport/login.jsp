...
function changeImg(){
	var path = "${path}/user/getImage.do?r="+new Date();
		...
		<form id="jvForm" action="${path }/user/login.do" method="post">
		  <input id="tip" type="hidden" value="${tip }">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img id="captchaImage" src="${path }/user/getImage.do" onclick="changeImg();" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="changeImg();" title="换一张">换一张</a></li>
