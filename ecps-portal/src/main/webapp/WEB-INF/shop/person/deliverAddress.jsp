...
function modify(shipAddrId){
	$.ajax({
		...
		success:function(responseText){
			...
			$("#privince").val(jsonObj.addr.privince);
	...
	<div class="r wr profile">
		...
		<div class="confirm">
			...
			<c:forEach items="${addrList }" var="addr">
				...
				<td><a href="javascript:void(0);" title="修改" onclick="modify(${addr.shipAddrId})" class="blue">[修改]</a><a href="${path}/user/login/deleteAddr.do?shipAddrId=${addr.shipAddrId }" title="删除" class="blue">[删除]</a></td>                  
				</tr>
		    </c:forEach>
				...
				<form id="jvForm" action="${path }/user/login/saveOrUpdateAddr.do" method="post">
					...
					<li>
						<label for="shipName"><samp>*</samp>收货人姓名：</label>
